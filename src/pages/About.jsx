...
const About = () => {
    return (
        ...
        <div className="mt-10 relative">
          ...
          <p className="font-bold text-2xl capitalize dark:text-black">Introducing about </p>
          <p className="font-bold text-5xl capitalize mt-2 dark:text-black">true beauty</p>
          </div>
        </div>
        <div className="mt-10 space-y-20">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10">
            ...
            <div className="flex-1">
              <p className="text-3xl font-bold text-rose-700 dark:text-white">Positive Reinforcement</p>
              <p className="text-lg font-semibold mt-10 text-rose-700 dark:text-white">It takes a lot of practice and intention to love yourself. That's why we promise always to include a motivational message on all our products! There are a lot of negative messages out there, and we encourage you to start every day with positivity.</p>
            </div>
          </div>
          {/* 2 */}
         <div className="flex flex-col  justify-center md:flex-row-reverse items-center gap-10">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10">
            ...
            <div className="flex-1">
              <p className="text-3xl font-bold text-rose-700 dark:text-white">Simplicity</p>
              <p className="text-lg font-semibold mt-10 text-rose-700 dark:text-white">We realize that you’re really busy– All. The. Time. That’s why we focus on making no-fuss products that are easy to use and multi-purpose. We never want you to be overwhelmed by your beauty routine. It should be a ritual that you enjoy.</p>
            </div>
          </div>
          {/* 4 */}
          <div className="flex flex-col  justify-center md:flex-row-reverse items-center gap-10">
