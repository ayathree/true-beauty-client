...
const UpdateProducts = () => {
    ...
    return (
        <div className="m-10">
    <h2 className="text-rose-600 text-center capitalize text-2xl font-bold mt-10 underline">Update Products</h2>
    ...
    <form onSubmit={handleFormSubmission}>
        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <select name="brand" defaultValue={brand} className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring " required>
                    <option value=""></option>
